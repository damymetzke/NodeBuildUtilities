...
import { runScript, runParallelScript, runNpm, ShellOptions, runShell, runBuildScript } from "./scriptLoader";
...
export function bindShell(program: string, args: string[], options: Partial<ShellOptions>): () => Promise<void>
{
    return _.bind(
        runShell, null,
        program,
...
export function bindBin(program: string, args: string[], options: Partial<ShellOptions>): () => Promise<void>
{
    return _.bind(
        runBin, null,
        program,
