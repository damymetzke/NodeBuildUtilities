...
export type FileCallback = (sourcePath: string, fileName: string, outputFolder: string) => Promise<FileCallbackResult>;
...
async function walkImplementation(sourceDirectory: string, outputDirectory: string, callback: FileCallback, options: WalkOptions, depth: number): Promise<WalkResult>
{
...
export function walk(sourceDirectory: string, outputDirectory: string, callback: FileCallback, options: Partial<WalkOptions>): Promise<WalkResult>
{
